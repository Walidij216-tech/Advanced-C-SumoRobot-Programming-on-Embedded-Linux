...
volatile unsigned int ADC10CTL0;   // Contrôle ADC10 registre 0
volatile unsigned int ADC10CTL1;   // Contrôle ADC10 registre 1
volatile unsigned int ADC10AE0;    // Activation des entrées ADC10
volatile unsigned int ADC10DTC0;   // Configuration du transfert de>
volatile unsigned int ADC10DTC1;   // Configuration du transfert de>
volatile unsigned int ADC10SA;     // Adresse du bloc de transfert >
volatile unsigned int ADC10IFG;  
